 ...
 *
 * @property modelName       Internal model name read from GATT GAP service (2A00). May differ from [deviceName].
 * @property deviceName BLE advertising packet name observed during scan. Separate from [modelName].
